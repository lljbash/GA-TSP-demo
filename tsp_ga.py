    ...
    for it in tqdm.trange(max_iters):
        if it == 0:
            ...
            for i in range(ncross):
                ...
                new_population[nreserve+i] = cross(population[parents_idx])
...
if __name__ == '__main__':
    ...
    length, route, it = ga(distance_matrix, population_size=128, cross_rate=0.9, mutation_rate = 0.05, max_iters=20000, thres=1000)
    print("iteration:", it)
    print("length:", length)
